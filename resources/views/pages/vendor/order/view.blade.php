  ...
  <div class="box box-primary">
    ...
    <div class="box-header with-border">
      ...
      <div class="pull-right">
        ...
        <a href="{{ url('/vendor/order') }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left">
     ...
     <div class="row invoice-info">
        ...
        <div class="col-md-3 invoice-col">
          ...
          <select class="form-control"  name="order_status" id="order_status">
            ...
            <option value="0" {{ $products[0]->status == 0 ? 'selected="selected"' : '' }}>Order placed</option>
        ...
        {!! Form::open(array('route' => ['vendor-order-estimate_date', $products[0]->order_id], 'method' => 'post', 'role' => 'form', 'class' => 'needs-validation','files' => true)) !!}
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      if (success == true) {
        ...
        url:"{{URL::to('vendor/order-status/')}}/"+order_status+"/"+order_id,

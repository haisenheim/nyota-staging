...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      ...
      {!! Form::open(array('route' => 'product.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation','id' => 'myform','enctype' => 'multipart/form-data' ,'files' => true)) !!}
...
url: "{{ route('vendorproduct.storeMedia') }}",

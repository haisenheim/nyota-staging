...
<div class="row">
  <div class="col-md-12">
    ...
    @endif
    {!! Form::open(array('route' => ['vendor-product-storecomment', $id], 'method' => 'POST','role' => 'form', 'class' => 'needs-validation','id' => 'myform','enctype' => 'multipart/form-data' ,'files' => true)) !!}
    {!! csrf_field() !!}
    <div class="box-body">
      <div class="row">
  ...
  <div class="col-md-12">
    ...
    <div class="box-comment">
      ...
      <div class="comment-text">
        ...
        <p><small>{!! Form::open(array('url' => 'vendor/products/deletecomment/' . $comment->id, 'class' => '', 'data-toggle' => 'tooltip')) !!}
        ...
        {!! Form::close() !!}  <a class="btn btn-xs btn-info" href="{{ URL::to('/vendor/products/editcomment/' . $comment->id ) }}">Edit</a></small></p>
      </div>
      <hr>
      @endforeach
    </div>

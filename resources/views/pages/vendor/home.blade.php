...
@section('content')
    	...
    	<div class="row das-color vendor-box">
    		<div class="col-lg-6  ">
            <!-- small box -->
            <div class="small-box bg-info">
              ...
              <a href="{{url('vendor/product')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-6  das-color">
            <!-- small box -->
            <div class="small-box bg-success">
              ...
              <a href="{{url('vendor/cart/')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
    	</div>
    	<div class="row">
          ...
          <div class="col-md-6">
            <div class="box box-info">
              ...
              <div class="box-body">
                <div class="table-responsive" id="yearcontainer">
...
$('#year').change(function(){
    ...
    if(year){
        $.ajax({
           type:"GET",
           url:"{{URL::to('admin/home/get-vendorchart-list/')}}/"+year,

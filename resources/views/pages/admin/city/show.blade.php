  ...
  <div class="col-lg-12">
    ...
    <div class="box box-primary">
      ...
      <div class="row row-box">
        ...
        <a class="btn btn-primary btn-sm" href="{{ URL::to('/admin/city/create') }}">
      ...
      <div class="col-lg-10">
              ...
              <div class="row">
                ...
                {!! Form::open(['route' => 'search-city','method' => 'get', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_pages']) !!}
                      ...
                      @foreach($citys as $city)
                       ...
                       {{--   <td>{{$city->country}}</td> --}}
                          ...
                          <td>
                            ...
                            {!! Form::open(array('url' => 'admin/city/' . $city->id, 'class' => '', 'data-toggle' => 'tooltip')) !!}

                            {!! Form::hidden('_method', 'DELETE') !!}

                            {!! Form::button('<i class="fa fa-trash-o"></i>', array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width:auto; float:left;margin-right:5px;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete City', 'data-message' => 'Are you sure you want to delete this city ?')) !!}

                            {!! Form::close() !!}

                            <a class="btn btn-sm btn-info" href="{{ URL::to('/admin/city/' . $city->id . '/edit') }}" data-toggle="tooltip">

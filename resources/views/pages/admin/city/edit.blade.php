...
<div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => ['city.update', $city->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation','files' => true)) !!}
              ...
              <div class="box-body">
              	...
              	<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<div class="form-group col-lg-6 col-md-6 col-sm-6">
						...
						{!! Form::text('name', $city->name, array('id' => 'name', 'class' => 'form-control', 'placeholder' => '')) !!}
					...
					<select class="form-control" name="country" id="country">
                      ...
                      @if ($countries)
                        ...
                        @foreach($countries as $country)
                          ...
                          <option value="{{ $country->id }}" {{ $country->id == $city->countryid ? 'selected="selected"' : '' }}>{{ $country->country_name }}</option>

  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      ...
      <div class="row row-box">
        ...
        <a class="btn btn-primary btn-sm" href="{{ URL::to('/admin/banner/create') }}">
          Create
        </a>
      </div>
      {{--<div class="col-lg-10">
                  ...
                  <table id="datatable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      @foreach($banners as $banner)
                     	<tr>
                          <td><img src="{{ url('public/banner')}}/{{$banner->image}}" height="50px" width="50px" class="responsive"></td>
                          <td>
                            {!! Form::open(array('url' => 'admin/banner/' . $banner->id, 'class' => '', 'data-toggle' => 'tooltip')) !!}
                            {!! Form::hidden('_method', 'DELETE') !!}
                            {!! Form::button('<i class="fa fa-trash-o"></i>', array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width:auto; float:left;margin-right:5px;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Banner', 'data-message' => 'Are you sure you want to delete this banner ?')) !!}
                            {!! Form::close() !!}
                            <a class="btn btn-sm btn-info" href="{{ URL::to('/admin/banner/' . $banner->id . '/edit') }}" data-toggle="tooltip">

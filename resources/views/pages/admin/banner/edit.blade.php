...
<div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => ['banner.update', $banner->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation','files' => true)) !!}
				{!! csrf_field() !!}
              <div class="box-body">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="form-group col-lg-6 col-md-6 col-sm-6">
						...
						<select name="product" class="form-control">
							...
							@foreach($products as $product)
								<option value="{{ $product->id }}" {{ $product->id == $banner->product ? 'selected="selected"' : '' }}>{{ $product->name }}</option>
							@endforeach
						</select>
					...
					<div class="form-group col-lg-6 col-md-6 col-sm-6">
	                    ...
	                    <div class="input-group">
						  ...
						  <img src="{{url('/public/banner')}}/{{$banner->image}}" alt="products" class="img-responsive">
	                      @endif  
	                    </div>
						 <span class="help-block">

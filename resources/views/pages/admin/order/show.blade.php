...
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary">
      ...
      <div class="col-lg-12">
              <div class="row">
                {!! Form::open(['route' => 'search-order','method' => 'get', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_pages']) !!}
                 {!! csrf_field() !!}
                  ...
                  <table id="datatable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      @foreach($orders as $order)
                        ...
                        <td><a class="btn btn-sm btn-primary" href="{{ URL::to('/admin/order/' . $order->order_id ) }}" data-toggle="tooltip"><i class="fa fa-eye"></i></a></td>
                      </tr>
                      @endforeach

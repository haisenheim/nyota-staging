  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      ...
      <div class="row row-box">
        ...
        <a class="btn btn-primary btn-sm" href="{{ URL::to('/admin/district/create') }}">
          Create
        </a>
      </div>
      <div class="col-lg-10">
              <div class="row">
                {!! Form::open(['route' => 'search-district','method' => 'get', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_pages']) !!}
                 {!! csrf_field() !!}
                    ...
                    <tbody>
                      @foreach($districts as $district)
                     	<tr>
                          ...
                          <td>
                            {!! Form::open(array('url' => 'admin/district/' . $district->id, 'class' => '', 'data-toggle' => 'tooltip')) !!}
                            {!! Form::hidden('_method', 'DELETE') !!}
                            {!! Form::button('<i class="fa fa-trash-o"></i>', array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width:auto; float:left;margin-right:5px;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete District', 'data-message' => 'Are you sure you want to delete this district ?')) !!}
                            {!! Form::close() !!}
                            <a class="btn btn-sm btn-info" href="{{ URL::to('/admin/district/' . $district->id . '/edit') }}" data-toggle="tooltip">

          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				...
				<div class="pull-right">
					<a href="{{ url('/admin/products/addcomment/'.$comment->product_id) }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(array('route' => ['product-updatecomment', $comment->id], 'method' => 'POST','role' => 'form', 'class' => 'needs-validation','id' => 'myform','enctype' => 'multipart/form-data' ,'files' => true)) !!}
				{!! csrf_field() !!}
              <div class="box-body">
              	<div class="row">

  ...
  <div class="col-md-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        ...
        <a href="{{ url('/admin/orderhistory') }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div id="PDFtitle"><b class="" style="font-size: 30px; background-color: #808080">Order History</b></div>
            ...
            <div id="PDFordertag"><b>Delievery Tag: </b>@if($products[0]->delievery_tag != NULL)
          ...
          <div class="col-md-4 invoice-col">
              ...
              {{--<div id="PDFaddcontent">@php
                if(!empty($products[0]->useraddress)){
                  $str = $products[0]->useraddress;
                  $address = explode(",",$str);
                  foreach($address as $str){
                  echo '<div id="PDFaddcontent">'. $str.'<br></div>';
                  }
                  echo '<div id="PDFaddcontent1">Phone: '. $products[0]->phone.'<br></div>';
                  }
                @endphp</div>--}}
        ...
        <div class="row">
          <div class="col-xs-12 table-responsive">
            ...
            <div id="PDFproducttable"><table class="table table-striped" id="basic-tables" >
              <thead>
                <tr>
       ...
       <div class="row invoice-info">
          <div class="col-md-4 invoice-col" >
            <div id=""><b class="">Order Details</b></div><br>
            <div class="col-md-6 invoice-row"><b>Order ID:</b></div><div class="col-md-6">{{$products[0]->order_id}}</div>
            <div class="col-md-6 invoice-row"><b>Customer Name:</b></div><div class="col-md-6">{{$products[0]->first_name}}</div>
...
<script type="text/javascript">
 $(document).ready(function(){
    $('#dwn-pdf').click(function(){
       ...
       doc.setFontSize(1);
       var res = doc.autoTableHtmlToJson(document.getElementById("basic-tables"));
        var options = {
        margin: {
          top: 300
        },
      ...
      doc.fromHTML($('#PDFordertag').html(), 80, 180, {
      'width': 100000000,
      });

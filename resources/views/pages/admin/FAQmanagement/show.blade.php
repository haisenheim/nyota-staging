  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      ...
      <div class="row row-box">
        ...
        <a class="btn btn-primary btn-sm" href="{{ URL::to('/admin/faq/create') }}">
          Create
        </a>
      </div>
      <div class="col-lg-10">
              <div class="row">
                {!! Form::open(['route' => 'search-faq','method' => 'get', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_pages']) !!}
                 {!! csrf_field() !!}
                    ...
                    <tbody>
                      @foreach($faqs as $faq)
                     	<tr>
                          <td>{{$faq->question}}</td>
                          <td>
                            {!! Form::open(array('url' => 'admin/faq/' . $faq->id, 'class' => '', 'data-toggle' => 'tooltip')) !!}
                            {!! Form::hidden('_method', 'DELETE') !!}
                            {!! Form::button('<i class="fa fa-trash-o"></i>', array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width:auto; float:left;margin-right:5px;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete FAQ', 'data-message' => 'Are you sure you want to delete this FAQ ?')) !!}
                            {!! Form::close() !!}
                            <a class="btn btn-sm btn-info" href="{{ URL::to('/admin/faq/' . $faq->id . '/edit') }}" data-toggle="tooltip">

...

{
    ...
    {   
        ...
        return View('pages.vendor.productsmanagement.show', compact('products'));
...

    {
        ...
        return view('pages.vendor.productsmanagement.create', compact('categories','attributetypes','child_categories'));
     ...
     public function addcomment($id){
      ...
      return view('pages.vendor.productsmanagement.addcomment',compact('id','comments'));
    ...
    public function editcomment($id){
      ...
      return view('pages.vendor.productsmanagement.editcomment',compact('comment'));
    ...
    public function updatecomment(Request $request, $id){
     ...
     $comment = Comment::where('id',$id)->update($datatwo);
      ...
      return redirect('vendor/products/addcomment/'.$request->input('product_id'))->with('success', 'Record Update successfully');
...

    {
        ...
        [
           ...
           'attributes.*.rprice.gte' => 'The price must be at least sale price.',
        ...
        $product = Product::create([
           ...
           // 'latitude'          => $request->input('latitude'),
            ...
            'attribute_type_id' => implode(", ",$request->attribute),              
       ...
       // return redirect('vendor/product')->with('success', 'Record insert successfully');
...

    {
        ...
        return view('pages.vendor.productsmanagement.view',compact('product','medias','mailatt','seletedatts','currency'));
...

    {
       ...
       $medias =      DB::table('media')
        ...
        return view('pages.vendor.productsmanagement.edit',compact('product','categories','medias','attributetypes','mailatt','seletedatts','child_categories'));
...

    {
        ...
        //     $filename       = Carbon::now()->format('Ymdhis').'product'.'.'.$product_image->getClientOriginalExtension();

        //     $save_path      = public_path().'/product_images/';

        //     $path           = $save_path.$filename;

        //     $public_path    = url('/').'/public/product_images/'.$filename;

        //     Image::make($product_image)->save($save_path.$filename);

        //     $image          = array('image' => $filename );

        //     $mediarry       = array('module_type' => 0, 'module_id' => $id );

        //     $media          = Gallery::where($mediarry)->update($image);
...

    {
        ...
        $html .= '</div><div class="col-lg-12 col-md-12 col-sm-12 no-padding"><div class="form-group col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="form-group col-lg-3 col-md-3 col-sm-3">
                  ...
                  <input type="number" step="1" name="attributes['.$variable.'][quantity]" id="quantity" value="" min="0" class="form-control" required>
